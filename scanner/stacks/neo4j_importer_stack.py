...
#     def __init__(self, scope: cdk.Construct, construct_id: str, vpc: IVpc, bucket_name: str, instance: IInstance, neo4j_user_secret: ISecret, **kwargs) -> None:
...
#         # bucket = Bucket.from_bucket_name(self, 's3-bucket-altimeter', bucket_name=bucket_name)
#         # self.neo4j_importer_function.add_event_source(
